...
const renderer = new THREE.WebGLRenderer({ antialias: true, powerPreference: "high-performance", alpha: true }); // Added alpha
...
// Append to specific container if possible, else body and style it
renderer.domElement.id = 'blackhole-canvas';
...
// Remove UI toggles for simplicity in background version
/*
let autoRotateEnabled = false;
const autoRotateToggle = document.getElementById('autoRotateToggle');
...
*/
// Set auto rotate true by default for background effect?
